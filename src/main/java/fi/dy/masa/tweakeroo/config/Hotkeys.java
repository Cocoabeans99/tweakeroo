...
public class Hotkeys
{
    ...
    public static final ConfigHotkey ELYTRA_CAMERA                      = new ConfigHotkey("elytraCamera",                      "",     KeybindSettings.PRESS_ALLOWEXTRA, "开启飞行视角模式");
    ...
    public static final ConfigHotkey FLEXIBLE_BLOCK_PLACEMENT_OFFSET    = new ConfigHotkey("flexibleBlockPlacementOffset",      "LCONTROL", KeybindSettings.PRESS_ALLOWEXTRA, "*用于将方块放置在偏移或对角线位置");
    public static final ConfigHotkey FLEXIBLE_BLOCK_PLACEMENT_ROTATION  = new ConfigHotkey("flexibleBlockPlacementRotation",    "LMENU", KeybindSettings.PRESS_ALLOWEXTRA, "*用于放置具有旋转/面向的方块");
    public static final ConfigHotkey FLY_PRESET_1                       = new ConfigHotkey("flyPreset1",                        "",     KeybindSettings.INGAME_BOTH, "切换至飞行预设 1");
    public static final ConfigHotkey FLY_PRESET_2                       = new ConfigHotkey("flyPreset2",                        "",     KeybindSettings.INGAME_BOTH, "切换至飞行预设 2");
    public static final ConfigHotkey FLY_PRESET_3                       = new ConfigHotkey("flyPreset3",                        "",     KeybindSettings.INGAME_BOTH, "切换至飞行预设 3");
    public static final ConfigHotkey FLY_PRESET_4                       = new ConfigHotkey("flyPreset4",                        "",     KeybindSettings.INGAME_BOTH, "切换至飞行预设 4");
    ...
    public static final ConfigHotkey INVENTORY_PREVIEW                  = new ConfigHotkey("inventoryPreview",                  "LMENU", KeybindSettings.PRESS_ALLOWEXTRA, "激活内容预览的按键");
    ...
    public static final ConfigHotkey PLACEMENT_RESTRICTION_MODE_FACE    = new ConfigHotkey("placementRestrictionModeFace",      "Z,2",  "切换放置限制模式至面对模式");
    ...
    public static final ConfigHotkey ZOOM_ACTIVATE                      = new ConfigHotkey("zoomActivate",                      "",     KeybindSettings.PRESS_ALLOWEXTRA, "激活缩放热键");
